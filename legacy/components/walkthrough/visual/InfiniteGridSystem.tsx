...
import { getTone } from '../../../../app/lib/tonnetz/tonnetz';
import {
    getWorldToGrid,
    ...
    CAMERA_HEIGHT,
    SPACING,
} from '../../../../app/lib/tonnetz/tonnetz-grid';
import { useSpatialDetection, DetectionResult, InteractionMode, NodeCandidate } from '../../../../app/components/walkthrough/shared/hooks/useSpatialDetection';
    ...
    useFrame(() => {
        ...
        if (detection && detection.isStructureChanged) {
            ...
            detection.activeNodes.forEach(node => {
                const idx = getNodeIndex(node.u, node.v, centerU, centerV, VIEW_RADIUS);
