...
export function GridLines({ isMajor }: GridLinesProps) {
    ...
    useFrame((_, delta) => {
        ...
        uniforms.uMajorColor.value.set(hexToThreeColor(edgeMajorBloomColor));
        uniforms.uMinorColor.value.set(hexToThreeColor(edgeMinorBloomColor));
        uniforms.uNeutralColor.value.set(hexToThreeColor(edgeNeutralBloomColor));
