...
import { getAdjacentNodes, getNodeWorldPosition } from '../core/ToneSystem';
...
export function ActiveHighlight({ mode, activeNodes, isMajor }: ActiveHighlightProps) {
    ...
    useFrame((_, delta) => {
        ...
        const majorCol = new THREE.Color(hexToThreeColor(hlMajorColor));
        const minorCol = new THREE.Color(hexToThreeColor(hlMinorColor));
        const neutralCol = new THREE.Color(hexToThreeColor(hlNeutralColor));
