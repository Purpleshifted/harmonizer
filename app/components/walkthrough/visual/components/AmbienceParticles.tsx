...
import { VIEW_RADIUS } from '../core/ToneSystem';
...
import { hexToThreeColor } from '../utils/color';
...
export function AmbienceParticles({ isMajor }: AmbienceParticlesProps) {
    ...
    useFrame((_, delta) => {
        ...
        dm.uniforms.uMajorColor.value.set(hexToThreeColor(dustMajorBloomColor));
        dm.uniforms.uMinorColor.value.set(hexToThreeColor(dustMinorBloomColor));
        dm.uniforms.uNeutralColor.value.set(hexToThreeColor(dustNeutralBloomColor));
