...
export function GridDots({ setLocationInfo, onDetectionUpdate, isMajor }: GridDotsProps) {
    ...
    useFrame((_, delta) => {
        ...
        dm.uniforms.uMajorColor.value.set(hexToThreeColor(nodeMajorBloomColor));
        dm.uniforms.uMinorColor.value.set(hexToThreeColor(nodeMinorBloomColor));
        dm.uniforms.uNeutralColor.value.set(hexToThreeColor(nodeNeutralBloomColor));
